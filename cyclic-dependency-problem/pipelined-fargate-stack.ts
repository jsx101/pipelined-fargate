...
export class PipelinedFargateStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const fargateService = new FargateStack(this, "FargateService", repoName);
    const updateFargatePipeline = new UpdateFargatePipelineStack(this, "UpdateFargatePipeline", repoName);

    
    const service = fargateService.buildFargateService(clusterName, serviceName, repoName, port, memoryLimitMiB, cpu);
    updateFargatePipeline.build(service);
  }
}
